...
INSERT INTO join_request (party_id, member_id, request_status, requested_at)
VALUES
(1,4,'PENDING','2026-05-21 10:00:00'),
(1,5,'APPROVED','2026-05-21 11:00:00'),
(2,6,'PENDING','2026-05-22 09:30:00'),
(2,7,'REJECTED','2026-05-22 10:30:00'),
(3,8,'PENDING','2026-05-23 14:00:00'),
(5,10,'APPROVED','2026-05-24 15:00:00'),
(6,1,'PENDING','2026-05-25 08:00:00'),
(7,9,'REJECTED','2026-05-25 16:20:00'),
(9,2,'PENDING','2026-05-26 12:10:00'),
(10,3,'PENDING','2026-05-27 19:00:00');

INSERT INTO party_settlement (party_id, settlement_month, total_amount, settlement_status)
VALUES
(1, '2026-05', 17000, 'PENDING'),
(2, '2026-05', 13500, 'COMPLETED'),
(3, '2026-05', 9900, 'PENDING'),
(4, '2026-05', 13900, 'COMPLETED'),
(5, '2026-05', 13900, 'PENDING'),
(6, '2026-05', 10900, 'PENDING'),
(7, '2026-05', 17000, 'PENDING'),
(8, '2026-05', 13500, 'COMPLETED'),
(9, '2026-05', 12900, 'PENDING'),
(10, '2026-05', 7890, 'PENDING'),
(1, '2026-06', 17000, 'PENDING'),
(5, '2026-06', 13900, 'PENDING');
